...
1. Define a class Queue to implement queue data structure using list. Define __init__()
   method to create an empty list object as intance object member of Queue.
...
#********* Driver code for testing above codes *****************

q1 = Queue()
# print(q1.get_front())         # (Below codes written to handle errors and exceptions)
try:
    print(q1.get_front())
